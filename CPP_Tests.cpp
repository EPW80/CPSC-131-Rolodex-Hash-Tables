...
void testTableComplexity(Tests &tests)
{
	...
	//	Fast vs. Slow
	{
		...
		t->assertTrue(
			...
			"Larger table (less collisions) should be much faster to populate than a smaller table (more collisions). Larger table took " + timer1.milliseconds_s() + "ms while smaller table took " + timer2.milliseconds_s() + "ms." + " Collisions = " + to_string(table1.n_collisions()) + " vs. " + to_string(table2.n_collisions()) + "." + " Factor = " + to_string(static_cast<double>(timer2.microseconds()) / static_cast<double>(timer1.microseconds())));
